...
const EXHIBITS = [
  { id: 1, title: "Мраморный бюст Аполлона", era: "IV век до н.э.", collection: "Античность", img: BUST_IMG, desc: "Редкий образец эллинистической скульптуры, найденный при раскопках в Афинах. Изображает юного бога света и искусств." },
  { id: 2, title: "Золотая корона Ивана III", era: "XV–XVI век", collection: "Средневековье", img: CROWN_IMG, desc: "Великолепная корона, украшенная рубинами, сапфирами и изумрудами. Символ монаршей власти эпохи Московского царства." },
  { id: 3, title: "Зал древних цивилизаций", era: "3000–500 до н.э.", collection: "Античность", img: HERO_IMG, desc: "Монументальный экспонат, воссоздающий атмосферу дворцовых залов Месопотамии с подлинными артефактами." },
  { id: 4, title: "Папирус из Луксора", era: "1350 до н.э.", collection: "Египет", img: BUST_IMG, desc: "Один из наиболее сохранившихся папирусных свитков эпохи Нового царства. Содержит фрагменты «Книги мёртвых»." },
  { id: 5, title: "Рыцарские доспехи", era: "XIII век", collection: "Средневековье", img: CROWN_IMG, desc: "Полный комплект пластинчатых доспехов рыцаря Священной Римской империи. Вес около 25 кг." },
  { id: 6, title: "Фреска из Помпей", era: "I век н.э.", collection: "Античность", img: HERO_IMG, desc: "Уцелевший фрагмент настенной росписи из атриума богатого дома. Сцена охоты с удивительной детализацией." },
];
